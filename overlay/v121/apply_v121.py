...
# The baseline final punctuation pass can leave a trailing period for a clearly
# interrogative «چرا ...» sentence. Repair only that narrow case so declarative
# clauses containing words such as «چی» keep their period.
